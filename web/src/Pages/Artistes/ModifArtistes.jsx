...
const ModifArtistes=({value,setOpen,setEtat,etat,artisteS})=>{
    const [artiste,setArtiste]=useState(artisteS)
    ...
    const sendData = async () => {
        ...
        contentBody.body = JSON.stringify(artiste);
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2} key={2}>
                                ...
                                <SoftInput
                                    defaultVal={artisteS?.tarif_heure}
                                    field={"tarif_heure"}
                                    setValue={setArtiste}
                                    type={"text"}
                                    value={artiste}
