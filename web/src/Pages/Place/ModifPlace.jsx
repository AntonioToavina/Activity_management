...
const ModifPlace =({value,setOpen,setEtat,etat,placeS,categories})=>{
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2} key={2}>
                                ...
                                <SoftSelect defaultValue={placeS?.categorieLieu.id} label="Categorie" f_item="type" data={categories} value={place} setValue={setPlace} field={"categorieLieu"} f_value={"id"} />
                            </SoftBox>
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2} key={2}>
                        ...
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2} key={2}>
                                ...
                                <SoftInput
                                    defaultVal={placeS?.reserve_place}
                                    field={"reserve_place"}
                                    setValue={setPlace}
                                    type={"number"}
                                    value={place}
