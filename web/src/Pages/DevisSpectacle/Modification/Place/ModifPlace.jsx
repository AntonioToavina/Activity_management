...
const ModifPlace=({value,setOpen,elementS,datas,etat,setEtat})=>{
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2} >
                             ...
                             <SoftSelect value={element} setValue={setElement} f_item={"nom"}  f_value={"id"} field={"lieu"} data={datas} defaultValue={elementS?.lieu?.id} />
                            </SoftBox>
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2}>
                        ...
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2}>
                                ...
                                <SoftInput defaultVal={elementS?.prix_vip} type="number" field="prix_vip" value={element} setValue={setElement} />
                            </SoftBox>
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2}>
                                ...
                                <SoftInput defaultVal={elementS?.prix_reserve} type="number" field="prix_reserve" value={element} setValue={setElement} />
                            </SoftBox>
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2}>
                                ...
                                <SoftInput defaultVal={elementS?.prix_normal} type="number" field="prix_normal" value={element} setValue={setElement} />
                            </SoftBox>
                        </Grid>
                    </Grid>
                </SoftBox>
