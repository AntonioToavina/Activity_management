...
const HomeDepenses_modif=({artistes,depenseartiste,setEtat,etat,id})=>{
    const [open, setOpen] = useState(false);
    const [openS, setOpenS] = useState(false);
    const { borderWidth } = borders;
    const headers = ["Id", "Type", "Montant"];
    ...
    const deleteElement=async(id)=>{
        ...
        await fetch(
            `http://localhost:8080/diversdepenses/${id}`,
            content
        )
    ...
    return <Grid item xs={12} md={6} xl={6}>
        <Card sx={{ minHeight: 350 }}>
            ...
            <ModifDepenses setEtat={setEtat} etat={etat} datas={artistes} value={open} setOpen={setOpen} elementS={element} />
            <AddDepense etat={etat} datas={artistes} value={openS} id={id} setEtat={setEtat} setOpen={setOpenS} />
            <SoftBox
                sx={{
...
export default HomeDepenses_modif