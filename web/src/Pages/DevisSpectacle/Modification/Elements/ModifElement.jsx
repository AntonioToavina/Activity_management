...
const ModifElement=({value,setOpen,elementS,datas,etat,setEtat,id})=>{
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2} >
                                ...
                                <SoftSelect defaultValue={elementS?.elementbases?.id} value={element} data={datas} field={"elementbases"} f_value={"id"} f_item={"nom"} setValue={setElement}  />
                            </SoftBox>
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <SoftBox mb={2}>
